...
public class CustomTexturedItem extends CustomItem implements ModelInjector {
	...
	public CustomTexturedItem(DamageableItem dItem, String customItemIdName, String defaultTexture) {
		super(dItem.getMaterial(), 1, (short) 0, customItemIdName, ItemType.getItemType(dItem.getMaterial()));
